...
import 'package:flutter_map_built_in/src/layer/label.dart';
...
class Polygon {
  ...
  Function(LatLngBounds polygonBounding) polygonBoundingBox;
  ...
  Polygon(
      ...
      required this.polygonBoundingBox})
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints bc) {
        ...
        for (final polygon in polygons) {
          ...
          polygon.polygonBoundingBox(polygon.boundingBox);
          polygonsWidget.add(
            // GestureDetector(onTap: (){
            //   debugPrint('Polgon center...${polygon.boundingBox.center}');
            //   if(polygon.boundingBox.contains(LatLng(-34.789212, -56.223734))) {
            //     debugPrint('Clicked on polygon paint');
            //   }},child:
            CustomPaint(
              key: polygon.key,
...
class PolygonPainter extends CustomPainter {
  ...
  bool? hitTest(Offset position) {
    debugPrint("Clicked on geofence...$position");
